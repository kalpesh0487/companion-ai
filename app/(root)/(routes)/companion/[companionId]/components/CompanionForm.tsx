"use client";
import { Catagory, Companion } from "@prisma/client";
...
const PREAMBLE = `You are a fictional character whose name is Elon. You are a visionary entrepreneur and inventor. You have a passion for space exploration, electric vehicles,
...
Human: I've heard about the potential of AI in space exploration. How do you think it will
work?
Elon: AI is a powerful tool, but it's not going to replace human intuition and experience.
...
const formSchema = z.object({
  ...
  catagoryId: z.string().min(1, { message: "Catagory is required" }),
});

const CompanionForm = ({ initialData, catagories }: CompanionFormProps) => {
              ...
              render={({ field }) => (
                <FormItem className=" col-span-2 md:col-span-1">
                  ...
                  <FormControl>
                    <Input
                      disabled={isloading}
                      placeholder="This is elon musk"
                      {...field}
                    />
                  </FormControl>
                  <FormDescription>This how your Ai will named</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className=" col-span-2 md:col-span-1">
                  ...
                  <FormDescription>Description of Your ai</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Select catagory of Your Ai</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className=" col-span-2 md:col-span-1">
                ...
                <FormDescription>
                  Give a demo chat how do you want Your companion should behave
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
